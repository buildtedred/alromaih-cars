...
import { ArrowLeft, Loader2, ImageIcon, Check, X, AlertCircle, ChevronRight, Pencil } from "lucide-react"
        ...
        <Card className="shadow-md border-brand-primary/10 overflow-hidden rounded-[5px]">
          ...
          <CardContent className="space-y-4 pt-4 px-4">
            <div className="flex flex-col items-center mb-2">
              <Skeleton className="h-24 w-24 rounded-[5px] mb-4" />
          ...
          <CardFooter className="flex justify-end gap-2 py-3 px-4 border-t bg-muted/20">
            ...
            <Skeleton className="h-8 w-24 rounded-[5px]" />
          </CardFooter>
        </Card>
      </div>
    )
    ...
    <div className="max-w-3xl mx-auto px-4 py-4 relative">
      ...
      {loading && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-card p-8 rounded-[5px] shadow-lg text-center w-1/2 h-1/2 flex flex-col items-center justify-center border border-brand-primary/20">
            ...
            <h3 className="font-medium text-2xl mb-4">Updating User</h3>
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div>
            <h1 className="text-xl font-bold tracking-tight text-brand-primary">Edit User</h1>
            <p className="text-xs text-muted-foreground">Update user information and permissions</p>
          </div>
          <Button
            variant="outline"
            size="sm"
      ...
      <Card className="shadow-md border-brand-primary/10 overflow-hidden rounded-[5px]">
        <form onSubmit={handleSubmit} aria-busy={loading}>
          <CardHeader className="bg-brand-light/30 border-b border-brand-primary/10 py-3 px-4">
            ...
            <CardDescription className="text-xs">Update the user's information</CardDescription>
          </CardHeader>
