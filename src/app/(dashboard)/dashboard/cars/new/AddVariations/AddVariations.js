                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleVariationChange(index, "colorName", e.target.value)}
                    />
                  </div>
                    ...
                    <div className="flex gap-2 items-center">
                      <div className="relative flex-1">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleVariationChange(index, "colorHex", e.target.value)}
                          placeholder="#000000"
                          className="pl-10"
                        />
                      </div>
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-3" align="end">
                          <AdvancedColorPicker
                            ...
                            onChange={(color) => handleVariationChange(index, "colorHex", color)}
                          />
                        </PopoverContent>
                      </Popover>
                    </div>
                      ...
                      {variation.images.map((img, imgIndex) => (
                        <div key={imgIndex} className="relative group aspect-square rounded-md overflow-hidden border">
                          ...
                          <Button
                            ...
                            onClick={() => removeImage(index, imgIndex, img.name)}
                          >
                            <X className="h-4 w-4" />
