...
export default function EditCarCarousel() {
  ...
  useEffect(() => {
    const fetchCarousel = async () => {
      try {
        const response = await fetch(`/api/supabasPrisma/car-carousel/${params.id}`)
        ...
        alert("Failed to fetch carousel: " + error.message)
      } finally {
        setLoading(false)
      }
    }
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <h1 className="text-3xl font-bold mb-6">Edit Car Carousel</h1>
