            ...
            >
              ...
              <div className="flex gap-3">
                <Link href="#" className="transition-transform hover:scale-105">
                  <Image src="/icons/Googleplay.svg" alt="Google Play" width={135} height={40} className="h-auto" />
                </Link>
                <Link href="#" className="transition-transform hover:scale-105">
                  <Image src="/icons/Appstore.svg" alt="App Store" width={135} height={40} className="h-auto" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="header-content-container py-4">
          ...
          >
            ...
            <div className="flex gap-6 items-center order-1 md:order-1">
              <Image src="/icons/Visa.svg" alt="Visa" width={45} height={30} className="object-contain" />
              <Image src="/icons/Mastercard.svg" alt="MasterCard" width={45} height={30} className="object-contain" />
              <Image src="/icons/Mada.svg" alt="Mada" width={45} height={30} className="object-contain" />
            </div>
            ...
            <div className="flex gap-4 order-2 md:order-3">
              <Image src="/icons/Maroof.svg" alt="Maroof" width={35} height={35} className="object-contain" />
              <Image src="/icons/Vat.svg" alt="VAT" width={35} height={35} className="object-contain" />
            </div>
          </div>
        </div>
      </div>
