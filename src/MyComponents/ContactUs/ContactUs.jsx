...
export default function ContactPage() {
  ...
  // Custom shadow style for contact cards
  const customShadow = {
    boxShadow: "0 10px 15px -3px #0000001a, 0 -3px 14px -4px rgba(0, 0, 0, 0.1)",
  }
        ...
        <div className="absolute left-0 right-0 top-[320px]">
          <div className="max-w-[calc(100%-1.5rem)] sm:max-w-[calc(100%-3rem)] md:max-w-[calc(100%-6rem)] lg:max-w-[calc(100%-10rem)] xl:max-w-[1300px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto px-4">
              {/* Working Hours Card */}
              <div className="bg-[#F8F2F8] rounded-xl p-6 text-center border border-gray-100" style={customShadow}>
              ...
              {/* Phone Card */}
              <div className="bg-[#C6AECC] rounded-xl p-6 text-center border border-gray-100" style={customShadow}>
        ...
        <div className="max-w-[calc(100%-1.5rem)] sm:max-w-[calc(100%-3rem)] md:max-w-[calc(100%-6rem)] lg:max-w-[calc(100%-10rem)] xl:max-w-[1300px] mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-1/4 flex items-center">
              <div className="bg-[#F8F2F8] rounded-xl p-6 w-full border border-gray-100" style={customShadow}>
