      ...
      <div className="space-y-2 sm:space-y-3 text-sm">
        ...
        {formData.paymentMethod === "finance" && formData.jobSector && (
          <div className="flex items-center">
            <FileText className="w-3 h-3 sm:w-4 sm:h-4 text-[#46194F] mr-2 flex-shrink-0" />
            <span className="text-gray-600">
              {isEnglish ? `Job Sector: ${formData.jobSector}` : `الوظيفة: ${formData.jobSector}`}
            </span>
          </div>
        )}
        ...
        {formData.paymentMethod === "finance" && formData.bankName && (
          <div className="flex items-center">
            <FileText className="w-3 h-3 sm:w-4 sm:h-4 text-[#46194F] mr-2 flex-shrink-0" />
            <span className="text-gray-600">
              {isEnglish ? `Bank: ${formData.bankName}` : `البنك: ${formData.bankName}`}
            </span>
          </div>
        )}
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="space-y-6">
                          <div className={`mb-6 relative ${isEnglish ? "text-left" : "text-right"}`}>
                            <label
                              className={`absolute top-0 ${isEnglish ? "left-0" : "right-0"} flex items-center text-gray-700 font-medium text-sm sm:text-base`}
                            >
                              <FileText
                            ...
                            <div
                              className={`absolute top-[38px] ${isEnglish ? "right-3" : "left-3"} pointer-events-none`}
                            >
                          ...
                          {formData.jobSector === "قطاع خاص" && (
                            <div className={`mb-8 relative ${isEnglish ? "text-left" : "text-right"}`}>
                              ...
                              <div className={`flex ${isEnglish ? "flex-row" : "flex-row-reverse"} gap-4`}>
                                ...
                                <label
                                  className={`flex items-center ${isEnglish ? "" : "flex-row-reverse"} py-3 px-6 border ${formData.bankVerified === "غير معتمد" ? "border-[#46194F] bg-[#46194F] shadow-md" : "border-gray-200 hover:border-purple-300 hover:bg-purple-50/30"} rounded-xl transition-all duration-200 cursor-pointer`}
                                >
                                  {isEnglish ? (
                                    <>
                                      <div
                          ...
                          <div className={`flex items-center ${isEnglish ? "justify-start" : "justify-end"} mb-8`}>
                            <div className="relative">
                              ...
                              <div
                                ...
                                onClick={() =>
                                  handleInputChange({
                                    target: { name: "hasWhatsapp", type: "checkbox", checked: !formData.hasWhatsapp },
                                  })
                                }
                              >
