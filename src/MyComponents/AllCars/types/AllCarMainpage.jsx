...
const RangeSlider = ({
  ...
  return (
    <div
      className="relative pt-1 pb-2 bg-brand-light p-1 rounded-lg"
      dir={isRTL ? "rtl" : "ltr"}
    >
...
const CarFilterSidebar = ({
  ...
  const areAllModelsSelected = useCallback(
    (brand) => {
      ...
      return brandModels.every((model) =>
  ...
  const handleFuelTypeChange = (fuelType, checked) => {
    let updatedFuelTypes = Array.isArray(filters.fuelTypes)
      ? [...filters.fuelTypes]
      : [];
  ...
  const handleTransmissionChange = (transmission, checked) => {
    let updatedTransmission = Array.isArray(filters.transmission)
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          maxHeight: isMobile ? "calc(100vh - 160px)" : "calc(100vh - 160px)",
          scrollbarWidth: "thin",
      ...
      >
        ...
        <div className="border-b border-brand-primary/25 pb-3 mb-3">
          ...
          >
            <h4 className="font-bold text-brand-primary text-base">
              {language === "ar"
                ? "اختر العلامة التجارية والطراز المناسب لك"
                : "Choose Brand & Model"}
            </h4>
            <div className="h-6 w-6 flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleBrandCheck(brand, checked)
                        }
                        className="h-4 w-4 rounded-[5px] border-2 border-brand-primary focus:ring-brand-primary"
                        style={{
                          backgroundColor: areAllModelsSelected(brand)
                            ? "#46194F"
                            : "transparent",
                          borderColor: areAllModelsSelected(brand)
                            ? "#46194F"
                            : "",
                        }}
                      />
                      ...
                      <div className="ml-6 mt-2 space-y-1 border-l-2 border-brand-primary/20 pl-3">
                        {modelsByBrand[brand]?.map((model) => (
                          ...
                          >
                            <Checkbox
                              id={`model-${model.id}`}
                              checked={filters.selectedModels?.includes(
                                model.id
                              )}
                              onCheckedChange={(checked) =>
                                handleModelCheck(model.id, checked)
                              }
                              ...
                              style={{
                                backgroundColor:
                                  filters.selectedModels?.includes(model.id)
                                    ? "#46194F"
                                    : "transparent",
                                borderColor: filters.selectedModels?.includes(
                                  model.id
                                )
                                  ? "#46194F"
                                  : "",
                ...
                .map((fuelType) => (
                  <div key={fuelType} className="flex items-center mb-2">
                    <Checkbox
                      id={`fuel-${fuelType}`}
                      checked={
                        Array.isArray(filters.fuelTypes) &&
                        filters.fuelTypes.includes(fuelType)
                      }
                      onCheckedChange={(checked) =>
                        handleFuelTypeChange(fuelType, checked)
                      }
                ...
                ...new Set(
                  cars.map((car) => {
                    ...
                    return typeof car.specs?.transmission === "object"
                      ? car.specs.transmission[language] ||
                          car.specs.transmission.en
                ...
                .map((transmission) => (
                  <div key={transmission} className="flex items-center mb-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleTransmissionChange(transmission, checked)
                      }
                      className="h-4 w-4 rounded-[5px] border-brand-primary border-2 focus:ring-brand-primary"
                      style={{
                        backgroundColor:
                ...
                .map((seatOption) => (
                  <div key={seatOption} className="flex items-center mb-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleSeatChange(seatOption, checked)
                      }
                      className="h-4 w-4 rounded-[5px] border-brand-primary border-2 focus:ring-brand-primary"
                      style={{
                        backgroundColor: filters.seats?.includes(seatOption)
                          ? "#46194F"
                          : "transparent",
                        borderColor: filters.seats?.includes(seatOption)
                          ? "#46194F"
                          : "",
                      }}
                    />
  ...
  const filteredCars = useMemo(() => {
    ...
    return cars
      .filter((car) => {
        ...
        if (
          car.cashPrice < filters.priceRange[0] ||
          car.cashPrice > filters.priceRange[1]
        ) {
          return false;
        }
        ...
        if (
          ...
          !filters.selectedModels.includes(car.id)
        ) {
          return false;
        }
        ...
        if (
          filters.year &&
          (!car.specs?.year || car.specs.year.toString() !== filters.year)
        ) {
          return false;
        }
        ...
        if (filters.transmission?.length > 0) {
          const carTransmission =
            typeof car.specs?.transmission === "object"
              ? car.specs.transmission[currentLocale] ||
                car.specs.transmission.en
              : car.specs?.transmission;
          if (
            !carTransmission ||
            !filters.transmission.includes(carTransmission)
          ) {
            return false;
          }
        }
      ...
      .sort((a, b) => {
        switch (sortOption) {
          ...
          case "newest":
            return (
              Number.parseInt(b.specs?.year || 0) -
              Number.parseInt(a.specs?.year || 0)
            );
          default:
            return 0;
        }
    ...
    <div className="container mx-auto py-8" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="lg:hidden mb-4">
        ...
        >
          ...
          <span>
            {currentLocale === "ar" ? "فلترة النتائج" : "Filter Results"}
          </span>
        </button>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          <div
            id="results-top"
            style={{ animation: "0.2s ease-out forwards fadeIn" }}
          >
            {loading ? (
              ...
              <div className="bg-white rounded-lg p-8 text-center shadow-md border border-gray-100">
                ...
                <h3 className="text-xl font-bold mb-2">
                  {isRTL ? "لم يتم العثور على سيارات" : "No Cars Found"}
                </h3>
